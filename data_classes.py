...
class Person:
    ...
    Properties:
    - employee_employee_first_name (str): The person's first name.
    - employee_last_name (str): The person's last name.

    ChangeLog:
    - Monisha Grover,12.10.2024, Created the class.
    """
...
class Employee(Person):
        ...
        def __init__(self, employee_first_name: str = "", employee_last_name: str = "", review_date: str = "1900-01-01",
                     review_rating: int = 3):

            super().__init__(employee_first_name=employee_first_name, employee_last_name=employee_last_name)
        ...
        def __str__(self):
            return f"{self.employee_first_name},{self.employee_last_name},{self.review_date},{self.review_rating}"