...
class IO:
    ...
    Monisha Grover,12.10.2024,Created Class
    """
    pass
    ...
    def output_error_messages(message: str, error: Exception = None):
        ...
        ChangeLog: (Who, When, What)
        Monisha Grover,12.10.2024,Created function
    ...
    def output_employee_data(employee_data: list):
        ...
        for employee in employee_data:
            ...
            print(message.format(employee.employee_first_name, employee.employee_last_name, employee.review_date, employee.review_rating))
        print("-" * 50)
        print()
    ...
    def input_employee_data(employee_data: list, employee_type=Employee):
        ...
        employee_object = Employee()  # Create an instance
        employee_object.last_name = "Smith"  # Correct attribute access

        try:
            # Input the data
            employee_object = employee_type()
            employee_object.employee_first_name = input("What is the employee's first name? ")
            employee_object.employee_last_name = input("What is the employee's last name? ")
